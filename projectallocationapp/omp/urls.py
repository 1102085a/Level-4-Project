...
urlpatterns = [
    ...
    url(r'^create_supervisor/$', views.add_project, name='add supervisor'),
    url(r'^create_administrator/$', views.add_project, name='add admin'),
    url(r'^create_preference/$', views.add_project, name='add preference'),
