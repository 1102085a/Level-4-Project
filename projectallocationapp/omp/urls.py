...
urlpatterns = [
    ...
    url(r'^add_student/$', views.add_student, name='add student'),
    url(r'^add_supervisor/$', views.add_project, name='add supervisor'),
    url(r'^add_administrator/$', views.add_project, name='add admin'),
    url(r'^add_preference/$', views.add_project, name='add preference'),
